...
public final class PaperGameLocator implements GameLocatorService {
  private static final BlackboardMap.@NotNull Key<Path> PAPER_JAR = Blackboard.key("ignite.paper.jar", Path.class, Paths.get("./.launcher/canvas-1.20.4-R0.1-SNAPSHOT.jar")); // Canvas
